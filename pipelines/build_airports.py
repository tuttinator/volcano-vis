...
PROFILES={'soekarno-hatta':222,'halim':122,'radin-inten':258,'budiarto':102,'pondok-cabe':482,'husein':242,'salakanagara':304,'muhammad-taufiq-kiemas':273,'atungbusu':302}
def build():
    ...
    for id,profile in PROFILES.items():
        ...
        records[-1]['retrievedAt']='2026-09-21' if id=='atungbusu' else '2026-09-12'
    (ROOT/'public/data/airports.json').write_text(json.dumps({'provider':'DGCA / Kementerian Perhubungan','retrievedAt':'2026-09-21','unresolved':[],'airports':records},indent=2)+'\n')
